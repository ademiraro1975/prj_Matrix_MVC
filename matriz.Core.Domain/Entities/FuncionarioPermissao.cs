...
public class FuncionarioPermissao
{
    ...
    public FuncionarioPermissao(int funcionarioId, string nome, string email, string fotoUrl)
    {
    ...
    public FuncionarioPermissao(int funcionarioId, int unidadeId, string nome, string email, string fotoUrl, string sistema, string rotina, string operacao)
    {
        FuncionarioId = funcionarioId;
        UnidadeId = unidadeId;
        Nome = nome;
